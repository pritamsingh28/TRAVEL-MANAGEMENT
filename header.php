...
<html lang="en-US">
  <head>
    ...
    <title> Go Travel.. - Chalo Ghumne Chale..</title>
  ...
  <body class="size-1140">
    ...
    <header role="banner">
        ...
        <div class="line">
          <div class="s-12 m-6 l-6">
            <div class="top-bar-contact">
              <p class="text-size-12">Contact Us: 0800 200 200 | <a class="text-orange-hover" href="mailto:contact@skylineindia.com">contact@skylineindia.com</a></p>
            </div>
          </div>
          <div class="s-12 m-6 l-6">
            <div class="right">
      ...
      <nav class="background-white background-primary-hightlight">
        <div class="line">
          <div class="s-12 l-2">
            <a href="index.php" class="logo"><img src="img/skylines_logo (1).png" alt=""></a>
          </div>
